...
impl Market for Contract {
    ...
    /// ## 7.1 Get reserves
    /// This function retrieves the current reserves of the contract.
    ///
    /// # Returns
    /// * [I256] - The reserves (in base_token_decimals).
    #[storage(read)]
    ...
    /// ## 9.7 Get utilization
    /// This function retrieves the current utilization of the market, defined as the ratio of total borrowed amount to total supplied amount.
    ///
    /// # Returns
    ...
    /// This function retrieves the current supply rate based on the market's utilization.
    ///
    /// # Arguments
    ...
    /// This function retrieves the current borrow rate based on the market's utilization.
    ///
    /// # Arguments
    /// * `utilization`: [u256] - The utilization of the market.
    ///
...
/// It returns the positive present supply balance if the principal is positive,
/// or the negative borrow balance if the principal is negative.
///
/// # Parameters
...
/// # Examples
/// ```sway
/// let value = present_value(principal);
/// ```
#[storage(read)]
...
/// # Examples
/// ```sway
/// let value = principal_value(present_value);
/// ```
#[storage(read)]
...
/// # Examples
/// ```sway
/// let utilization = get_utilization_internal();
/// ```
#[storage(read)]
...
/// # Examples
/// ```sway
/// let utilization = u256::from(0.7);
/// let supply_rate = get_supply_rate_internal(utilization);
/// ```
#[storage(read)]
...
/// # Examples
/// ```sway
/// let utilization = u256::from(0.75);
/// let borrow_rate = get_borrow_rate_internal(utilization);
/// ```
#[storage(read)]
...
/// # Examples
/// ```sway
/// let user_account = Identity::from(0x123);
/// let (supply, borrow) = get_user_supply_borrow_internal(user_account);
/// ```
#[storage(read)]
...
/// # Examples
/// ```sway
/// let current_time = timestamp().into();
/// let last_time = previous_accrual_time; 
/// let (supply_index, borrow_index) = accrued_interest_indices(current_time, last_time);
/// ```
#[storage(read)]
...
/// # Examples
/// ```sway
/// let account = Identity::from(0x123);
/// let is_collateralized = is_borrow_collateralized(account);
/// ```
#[storage(read)]
...
/// ```sway
/// let account = Identity::from(0x123);
/// let is_liquidatable = is_liquidatable_internal(account);
/// ```
#[storage(read)]
...
/// # Examples
/// ```sway
/// let asset_id = AssetId::from(0x123);
/// let reserves = get_collateral_reserves_internal(asset_id);
/// ```
#[storage(read)]
...
/// # Examples
/// ```sway
/// /// Assuming the market has some activity and time has passed
/// accrue_internal();
/// ```
#[storage(write)]
fn accrue_internal() {
...
/// let account = Identity::from(0x123);
/// let basic = UserBasic {
///     principal: I256::from(100),
///     base_tracking_index: 1000,
///     base_tracking_accrued: 50,
/// };
/// let principal_new = I256::from(150);
/// update_base_principal(account, basic, principal_new);
/// ```
#[storage(write)]
...
/// # Examples
/// ```sway
/// let old = I256::from(100);
/// let new = I256::from(150);
/// let (repay_amount, supply_amount) = repay_and_supply_amount(old, new);
/// ```
...
/// ```sway
/// let old = I256::from(100);
/// let new = I256::from(50);
/// let (withdrawn, borrowed) = withdraw_and_borrow_amount(old, new);
/// ```
