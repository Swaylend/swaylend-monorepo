        ...
        <TooltipTrigger>
          <div className="w-[174px] h-[174px] bg-background rounded-full flex items-center p-2 justify-center">
            <div className="w-full h-full relative">
              ...
              <div
                className={`w-full h-full ${bowlMode === 2 && 'bg-white/5 border-2 border-white/20'} flex-col ${bowlMode === 1 && 'bg-purple-500 text-neutral2'} ${bowlMode === 0 && 'bg-accent text-neutral6'} rounded-full flex justify-center items-center text-xl text-center font-semibold`}
              >
                {bowlMode === 2 && (
