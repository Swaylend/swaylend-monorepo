...
export type RedStoneErrorInput = Enum<{ EmptyAllowedSigners: undefined, EmptyFeedIds: undefined, SignerCountThresholdToSmall: undefined, DuplicatedSigner: undefined, DuplicatedFeedId: undefined, DuplicatedValueForSigner: [string, BigNumberish], SignerNotRecognized: [string, BigNumberish], InsufficientSignerCount: [BigNumberish, BigNumberish], TimestampOutOfRange: [boolean, BigNumberish, BigNumberish], TimestampDifferentThanOthers: [BigNumberish, BigNumberish, BigNumberish] }>;
export type RedStoneErrorOutput = Enum<{ EmptyAllowedSigners: void, EmptyFeedIds: void, SignerCountThresholdToSmall: void, DuplicatedSigner: void, DuplicatedFeedId: void, DuplicatedValueForSigner: [string, BN], SignerNotRecognized: [string, BN], InsufficientSignerCount: [BN, BN], TimestampOutOfRange: [boolean, BN, BN], TimestampDifferentThanOthers: [BN, BN, BN] }>;
...
export type CollateralConfigurationInput = { asset_id: AssetIdInput, price_feed_id: string, decimals: BigNumberish, borrow_collateral_factor: BigNumberish, liquidate_collateral_factor: BigNumberish, liquidation_penalty: BigNumberish, supply_cap: BigNumberish, paused: boolean, redstone_feed_id: BigNumberish };
export type CollateralConfigurationOutput = { asset_id: AssetIdOutput, price_feed_id: string, decimals: number, borrow_collateral_factor: BN, liquidate_collateral_factor: BN, liquidation_penalty: BN, supply_cap: BN, paused: boolean, redstone_feed_id: BN };
...
export type MarketConfigurables = Partial<{
  ...
  ALLOWED_SIGNERS: [string, string, string, string, string];
}>;
...
const abi = {
  ...
  "concreteTypes": [
    ...
    {
      "type": "[b256; 5]",
      "concreteTypeId": "05c8000243cac7cd2e590c4a0f8a1802b2cb6948fb6741cb46fd5262d0861195",
      "metadataTypeId": 7
    },
    {
      "type": "b256",
    ...
    },
    {
      ...
      "concreteTypeId": "c35d5ab61b0f170d72f36b2bc3a2e791d577f09fc0f50a1983096340d59ce09a",
      "metadataTypeId": 9
    },
    {
  ...
  "metadataTypes": [
    ...
    },
    {
      ...
      "components": [
        ...
        {
          "name": "base_token_redstone_feed_id",
          "typeId": "1b5759d94094368cfd443019e7ca5ec4074300e544e5ea993a979f5da627261e"
        },
        {
          "name": "supply_kink",
...
export class Market extends __Contract {
  ...
  declare functions: {
    absorb: InvokeFunction<[accounts: Vec<IdentityInput>, price_data_update: PriceDataUpdateInput, redstone_payload: Bytes], void>;
    ...
    available_to_borrow: InvokeFunction<[account: IdentityInput, redstone_payload: Bytes], BN>;
    balance_of: InvokeFunction<[asset_id: AssetIdInput], BN>;
    buy_collateral: InvokeFunction<[asset_id: AssetIdInput, min_amount: BigNumberish, recipient: IdentityInput, redstone_payload: Bytes], void>;
    collateral_value_to_sell: InvokeFunction<[asset_id: AssetIdInput, collateral_amount: BigNumberish, redstone_payload: Bytes], BN>;
    ...
    get_price: InvokeFunction<[price_feed_id: string, redstone_feed_id: BigNumberish, redstone_payload: Bytes], PriceOutput>;
    ...
    is_liquidatable: InvokeFunction<[account: IdentityInput, redstone_payload: Bytes], boolean>;
    ...
    quote_collateral: InvokeFunction<[asset_id: AssetIdInput, base_amount: BigNumberish, redstone_payload: Bytes], BN>;
    ...
    withdraw_base: InvokeFunction<[amount: BigNumberish, price_data_update: PriceDataUpdateInput, redstone_payload: Bytes], void>;
    withdraw_collateral: InvokeFunction<[asset_id: AssetIdInput, amount: BigNumberish, price_data_update: PriceDataUpdateInput, redstone_payload: Bytes], void>;
