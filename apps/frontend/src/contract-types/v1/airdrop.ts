...
export enum AccessErrorInput {
	...
	CallerNotPendingOwner = "CallerNotPendingOwner",
	Paused = "Paused",
...
export enum VerificationErrorInput {
	AccountIdToLarge = "AccountIdToLarge",
	IncorrectAccount = "IncorrectAccount",
	InvalidProof = "InvalidProof",
	NoSigner = "NoSigner",
}
export enum VerificationErrorOutput {
	AccountIdToLarge = "AccountIdToLarge",
	IncorrectAccount = "IncorrectAccount",
	InvalidProof = "InvalidProof",
	NoSigner = "NoSigner",
...
export type ClaimEventOutput = {
	amount: BN;
	claimer: string;
	to: IdentityOutput;
};
export type ClawbackEventInput = {
	asset_id: AssetIdInput;
	amount: BigNumberish;
	to: IdentityInput;
};
export type ClawbackEventOutput = {
...
export type OwnershipTransferEventInput = {
	from: IdentityInput;
	to: IdentityInput;
};
export type OwnershipTransferEventOutput = {
	from: IdentityOutput;
	to: IdentityOutput;
};
export type OwnershipTransferInitiatedEventInput = {
	from: Option<IdentityInput>;
	to: IdentityInput;
};
export type OwnershipTransferInitiatedEventOutput = {
	from: Option<IdentityOutput>;
	to: IdentityOutput;
};
...
const abi = {
	...
	concreteTypes: [
		...
		},
		{
			...
			concreteTypeId:
				"966a21e670944bac224061bac62f1f4d514ed5b6ddbb37a67dcfd0a17f6423c0",
			metadataTypeId: 0,
		},
		{
			type: "enum errors::InputError",
			concreteTypeId:
				"450f24be2388d767c2a3683c3a8f173b79f7f02437bf6098cd36ba13bfc4c1b2",
			metadataTypeId: 1,
		},
		{
			type: "enum errors::VerificationError",
			concreteTypeId:
				"830d3b5a51b6b713a3c93913be027ca77d17b627fcb50fab6474df96baf1da1b",
			metadataTypeId: 2,
		},
		{
		...
		{
			type: "enum sway_libs::merkle::common::ProofError",
			concreteTypeId:
				"99f00c07e2731313bdbbb5c6979c723f2f64e6c5d6f8106397a5aa93d2d5a5c4",
			metadataTypeId: 5,
		},
		{
			type: "struct events::ClaimEvent",
			concreteTypeId:
				"1fa0c6da5fd6fd691795bd27aadcc15cdc0280686eab924a3884591d8d82eeab",
			metadataTypeId: 8,
		},
		{
			type: "struct events::ClawbackEvent",
			concreteTypeId:
				"5ac9dc90a29a8a0a6c103ae358b2328b5f7ba992bba3d614ecf30567493cb1d2",
			metadataTypeId: 9,
		},
		{
			type: "struct events::OwnershipTransferEvent",
			concreteTypeId:
				"af74b4220e088155e62d336c5d550649398f4840a7bfbc29939da422c1a20c47",
			metadataTypeId: 10,
		},
		{
			type: "struct events::OwnershipTransferInitiatedEvent",
			concreteTypeId:
				"dcfc1df0609cb2dd4ca8d2ed1ecf3345f0e8e24b4dba52be214e10713290cccc",
			metadataTypeId: 11,
		},
		{
			type: "struct events::PauseChangeEvent",
			concreteTypeId:
				"68b78007febdb9c12cc535c7b120f5b4e11145114b85e2c44947fac773823991",
			metadataTypeId: 12,
		},
		{
	...
	declare functions: {
		claim: InvokeFunction<
			[
				amount: BigNumberish,
				account: string,
				tree_index: BigNumberish,
				proof: Vec<string>,
				recipient: IdentityInput,
			],
			BN
		>;
		clawback: InvokeFunction<
			[recipient: IdentityInput, asset_id: AssetIdInput],
			BN
		>;
		confirm_transfer_ownership: InvokeFunction<[], void>;
		end_time: InvokeFunction<[], BN>;
		initialize: InvokeFunction<[], void>;
		initiate_transfer_ownership: InvokeFunction<
