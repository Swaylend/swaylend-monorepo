...
export const Borrow = () => {
    ...
    const borrowedUSDTPrice = useMemo(() => {
        ...
        return priceDataUSDT.prices[marketConfigurationUSDT?.baseToken.bits].times(borrowedUSDT);
    ...
    const borrowedUSDCPrice = useMemo(() => {
        ...
        return priceDataUSDC.prices[marketConfigurationUSDC?.baseToken.bits].times(borrowedUSDC);
                        ...
                        {borrowedUSDC && (
                            <TableRow>
                                ...
                                <TableCell>
                                    ...
                                    {' '}
                                    {borrowedUSDC.toFixed(2)} USDC</TableCell>
                                <TableCell className={`font-semibold bg-card ${currentCollateralUtilizationUSDC > 80 && 'text-red-500'} ${currentCollateralUtilizationUSDC > 60 && currentCollateralUtilizationUSDC <= 80 && 'text-yellow-500'} ${currentCollateralUtilizationUSDC <= 60 && 'text-primary'}`}>
                                ...
                                <TableCell><div className="flex gap-x-1 items-center text-primary">
                                    <Image
                        ...
                        {borrowedUSDT && (
                            <TableRow>
                                ...
                                <TableCell>
                                    ...
                                    {' '}
                                    {borrowedUSDT.toFixed(2)} USDT</TableCell>
                                <TableCell className={`font-semibold bg-card ${currentCollateralUtilizationUSDT > 80 && 'text-red-500'} ${currentCollateralUtilizationUSDT > 60 && currentCollateralUtilizationUSDT <= 80 && 'text-yellow-500'} ${currentCollateralUtilizationUSDT <= 60 && 'text-primary'}`}>
