...
export class EventEntity extends AbstractEntity  {
  ...
  static update(values: UpdateValues<EventEntityConstructorInput>): Promise<void> {
    return getStore().update(EventEntity, values)
  }
}
...
export class Liquidation extends AbstractEntity  {
  ...
  static update(values: UpdateValues<LiquidationConstructorInput>): Promise<void> {
    return getStore().update(Liquidation, values)
  }
}
